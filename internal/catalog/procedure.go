...
type procedureRepository interface {
	PublishProcedure(context.Context, int64, func(petrunia.Net) error) (*Procedure, error)
}
...
func (s *ProcedureService) PublishProcedure(ctx context.Context, id int64) (*Procedure, error) {
