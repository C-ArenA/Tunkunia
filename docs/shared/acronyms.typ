#let acronyms = (
  ...
  "WFMS": (
    ...
    longplural: "Workflow Management Systems",
  ),
  "WF": "Workflow",
  ...
  "GAD": (
    short: "GAD",
    plural: "GADs",
    long: "Gobierno Autónomo Departamental",
    longplural: "Gobiernos Autónomos Departamentales",
  ),
  "GAM": (
    short: "GAM",
    plural: "GAMs",
    long: "Gobierno Autónomo Municipal",
    longplural: "Gobiernos Autónomos Municipales",
  ),
