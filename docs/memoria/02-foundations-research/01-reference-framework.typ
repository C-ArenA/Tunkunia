...
Para los teóricos de la armonía social, el Estado aparece como la solución colectiva de necesidades nuevas que surgen a partir de situaciones también nuevas @vacarofernandezOrigenEstado2000[pág. 3]. Se dice que esta organización representa un fenómeno político que *supuso la separación o la salida de lo político del terreno social* y *la conversión del individuo en un ciudadano*, cuya relación de pertenencia fundamental será con el Estado al margen de cualquier característica particular @gordilloperezPorQueSurge2017. Dicha separación se ve reflejada en los cuatro elementos clave mediante los cuales se materializa el Estado: territorio, población, gobierno y soberanía @delarocharadaElementosParaTeoria2019.
...
En consecuencia, se suele encontrar dentro del gobierno la figura de la administración pública, que gestiona los asuntos comunes respecto al ciudadano como miembro del Estado @guerreroCharlesJeanBonninSiglo2020. Esta ciencia tiene la importante responsabilidad de poner en *contacto directo* a la población con el poder político @mostajomachicadoDerechoAdministrativoAdministracion2016.

Para lograr este propósito los gobiernos casi siempre ponen en práctica la *burocracia* #footnote[término acuñado en el siglo 18 por el filósofo francés Vincent de Gournay, derivando del francés _bureau_ y _cratie_, que significan "Escritorio para escribir" y "Gobierno" respectivamente @rockmanBureaucracyStructureProcesses2024]. Según el sociólogo alemán Max Weber, no sólo es la forma más avanzada de ejercer o empuñar el poder por aquellos que lo controlan @watersWeberRationalismModern2015[pág. 114], sino también una *forma racional de organización* que, en su opinión, es la forma más pura de sistema legal de autoridad, es necesaria y tiene entre sus características fundamentales las jerarquías, la especialización y la definición estricta de *reglas y regulaciones* @archerDictionaryPublicAdministration2022.
...
La palabra trámite viene del latín "trames", "tramitis", que para los romanos significaba "senda" o "camino" @TramiteCastellanoPagina. Según la Real Academia de la Lengua Española, se define como "Cada uno de los *pasos* y diligencias que hay que recorrer en un asunto hasta su conclusión" @asaleDiccionarioLenguaEspanola. Algunos términos para referirse a lo mismo son "Procedimiento Administrativo", "Servicio Público Transaccional" o, en inglés, "Procedure" y "Paperwork".

Para efectos de este documento, se entiende por trámite al conjunto de requisitos, pasos o acciones a través de los cuales los individuos o las empresas *piden o entregan información* a una entidad pública, con *el fin de obtener* un derecho o *para cumplir* con una obligación @rosethFinTramiteEterno2018[pág. 36]. En su forma tradicional se realiza presencialmente en una oficina pública, donde el ciudadano presenta documentos y cumple requisitos que pueden involucrar otros trámites.
...
La Ley Nº 2341 tiene como uno de sus objetos "Establecer las normas que regulan la actividad administrativa y el *procedimiento administrativo* del sector público" @LeyNo23412002. Su Artículo 4, "Principios Generales de la Actividad Administrativa", incluye dos principios importantes en este contexto: el "Principio de eficacia" y el "Principio de economía, simplicidad y celeridad". El Artículo 16 lista, entre otros, los siguientes derechos:
...
Esta ley también define la acción correspondiente a los silencios administrativos y otras situaciones propias del proceso administrativo. Aunque es general, establece condiciones que pueden ser atendidas con un sistema digitalizado de gestión y seguimiento de trámites, como consultar el estado de un trámite u obtener copias de documentos que obren en poder de la administración pública.
...
El primero define los ejes y líneas estratégicas para implementar la política de gobierno electrónico en el país, como puede verse en la @table:ejes_egob. Estos ejes reflejan gran parte de lo establecido en las leyes y reglamentos relevantes para cualquier proyecto de software gubernamental.
...
El Decreto Supremo Nº 3525 tiene como uno de sus objetos normar la *tramitación digital* @DECRETOSUPREMO35252018. Si bien aún no se consigue poner en práctica la totalidad de dicha norma, se puede resaltar lo siguiente:
...
Lo anterior no sólo establece la obligación de digitalizar los trámites administrativos, sino también la interoperabilidad entre entidades públicas y la necesidad de resguardar la información de los administrados. Esto es clave para el funcionamiento del sistema propuesto, que se espera pueda integrarse con otros sistemas de información y servicios de interoperabilidad.

Muchos trámites que se digitalizan cuentan con documentos físicos importantes. Al respecto, el mismo decreto establece:
...
Durante la concepción de este proyecto, se presentó como situación actual un listado de normativas relevantes con efectos prácticos en el trabajo. Posteriormente, durante su desarrollo, se suscitaron cambios, siendo el más relevante la creación de manuales a partir del Decreto Supremo Nº 5340.
...
La emergencia sanitaria provocada por la pandemia de COVID-19 aceleró la implementación de @TICs en la administración pública. Por esto se aprobó, mediante Resolución Ministerial Nº 079/20, el documento de "Lineamientos y estándares técnicos para el desarrollo e implementación de Servicios Digitales", que insiste en la digitalización de servicios como el trámite, guía a las entidades públicas y privadas que desarrollan software con este propósito e indica la disponibilidad de herramientas creadas por la AGETIC, como Ciudadanía Digital.
