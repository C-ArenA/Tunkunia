...
Al ser un elemento especializado en trámites, esta pieza de software reutilizable vivirá en un entorno institucional donde podría interactuar con otros sistemas de ser necesario (Por ejemplo, con un sistema de gestión documental). Esto hace conveniente que al mismo se entienda como un *subsistema*, es decir, un elemento que puede funcionar de forma independiente, pero que a su vez puede ser parte de un sistema mayor @ingenoSoftwareArchitectsHandbook2018. Una visión general de su arquitectura, reflejando aquello, puede verse en la @fig:modulegraph, muy inspirada en la @fig:wfms_history.
