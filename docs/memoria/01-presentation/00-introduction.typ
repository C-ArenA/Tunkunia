...
Con el propósito de atacar funcionalidades recurrentes y brindar una herramienta que se pueda volver a utilizar en nuevos proyectos de este tipo, contribuyendo al *desarrollo* del gobierno electrónico en Bolivia, *facilitando* el paso de trámites en papel a procesos en línea @agenciadegobiernoelectronicoytecnologiasdeinformacionycomunicacionAGETICFirmaConvenio2026, en este documento se propone un *subsistema reutilizable de software libre para la gestión de flujos de trámite* que modele dichos procesos administrativos utilizando un gestor de flujos de trabajo especializado y adaptado al entorno nacional.

Asimismo, se describe el proceso de ingeniería de software correspondiente a un prototipo funcional evolutivo que implementa esta solución. A este artefacto se denomina *Tunkunia*, para facilitar su referencia y dotarlo de una identidad propia, en honor al tradicional juego boliviano que consiste en seguir una secuencia estructurada de movimientos para alcanzar un objetivo, de forma análoga al proceso del trámite.
