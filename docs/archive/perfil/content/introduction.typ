...
Durante el desarrollo del #acr("SIAI") del #acr(
  "MDPyEP",
) por parte de la empresa *2IES*,
...
Lo anterior se llevará a cabo recogiendo principalmente la experiencia adquirida en el desarrollo del #acr(
  "SIAI",
) por parte de 2IES
y atendiendo trámites descritos por el #acr(
  "RASIM",
) u otras normativas como ejemplos de aplicación.

Además, en favor de la soberanía tecnológica y la normativa vigente en Bolivia, se hará uso de software libre y estándares abiertos para la implementación del subsistema y se licenciará al mismo como #acr(
  "FOSS",
)#footnote[
