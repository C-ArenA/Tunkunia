...
- Tiempos de desarrollo mayores. Esto para el aparato estatal es un problema impensable, ya que la mayoría de sus licitaciones piden desarrollos en tiempo récord y ante la falta de módulos reutilizables, los proyectos corren peligro de fracasar por no cumplimiento de plazos.
