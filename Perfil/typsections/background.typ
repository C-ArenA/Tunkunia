...
#rect(fill: rgb("#bfe4fa88"), width: 100%)[
  La sociedad se organiza y evoluciona a la formación de estados, separando lo político de lo social.
]
...
#rect(fill: rgb("#bfe4fa88"), width: 100%)[
  ...
  Un mecanismo transversal a todas las instituciones es el *trámite*.
]

Dentro de los 4 componentes listados en el subtítulo anterior, el gobierno
(del griego $kappa mu beta epsilon rho v á omega$ kybernéin "pilotar un barco" o "capitán de un barco"),
...
que es "la que tiene la gestión de los asuntos comunes respecto al ciudadano como miembro del estado" @guerreroCharlesJeanBonninSiglo2020.
...
#rect(fill: rgb("#bfe4fa88"), width: 100%)[
  El trámite permite a la sociedad realizar acciones en conjunto con su gobierno. Sin embargo,
  conlleva a muchos problemas como la corrupción, exceso de burocracia y costos/tiempos de ejecución elevados.
]
...
También en español se puede referir al mismo como "Procedimiento administrativo" o "Servicio Público Transaccional".
...
#rect(
  fill: rgb("#bfe4fa88"),
  width: 100%,
)[El gobierno electrónico o gobierno digital nace como una propuesta para mitigar los problemas de la burocracia tradicional y mejorar los procesos administrativos, entre ellos el *trámite*, que es ubicuo en las diferentes instituciones públicas.]
